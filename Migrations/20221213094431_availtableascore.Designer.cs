...
namespace BSTableBooking.Migrations
{
    ...
    [Migration("20221213094431_availtableascore")]
    partial class availtableascore
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BSTableBooking.Models.Booking", b =>
                {
                    ...
                    b.Property<int>("AvailTablesSessionID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AvailTablesSessionID");
            ...
            modelBuilder.Entity("BSTableBooking.Models.Booking", b =>
                {
                    b.HasOne("BSTableBooking.Models.AvailTables", "AvailTables")
                        .WithMany()
                        .HasForeignKey("AvailTablesSessionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AvailTables");
                });
